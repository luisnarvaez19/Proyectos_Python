...
# se cuenta cuentas veces existe. Si cuantos es mayor que 1, es porque hay repetidos. Se guardan en
# una lista todos los repetidos que haya.
# Se usa posicion para encontrar todos los repetidos
...
# Una vez seleccionado cual es el partido seleccionado se hacen las siguientes 4 instrucciones
